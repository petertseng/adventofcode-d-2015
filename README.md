...
Have been checked for deprecation warnings up through 2.094.1, though other possible code improvements in the meantime have not necessarily been noticed.
